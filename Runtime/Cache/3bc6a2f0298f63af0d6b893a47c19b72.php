...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.btn-upcirpass').click(function(){
			...
			$('.alert-info-uppass').html("<img src='__ROOT__/hello/Public/img/ajax-loader.gif' class='loader-gif'></p>");
			$.post('__URL__/upcirpass',{circleid:circleid,cirpassword:password},function(data){
	...
	function queryMyFriend(pagechange,pagenum,condition){
		...
		$('.btn-usercenter-change').click(function(){
			...
			$('.btn-usercenter-change').html("<img src='__ROOT__/hello/Public/img/ajax-loader.gif' class='loader-gif'>");
			$.post('__URL__/alterUserMsg',{phonenumber:phonenumber},function(data){
